if select(2, UnitClass("Player")) == "PRIEST" then
	...
	if charportrait == true then
		WeakenedTargetFrame.Panel = BarPanel(8, 216, 0, 30, "TOPLEFT", "BOTTOMLEFT", oUF_Tukz_target, 1, WeakenedTargetFrame, "HIGH")
	else
		WeakenedTargetFrame.Panel = BarPanel(8, 250, 0, 30, "TOPLEFT", "BOTTOMLEFT", oUF_Tukz_target, 1, WeakenedTargetFrame, "HIGH")
	end
	...
	if charportrait == true then
		WeakenedPlayerFrame.Panel = BarPanel(8, 216, 34, 30, "TOPLEFT", "BOTTOMLEFT", oUF_Tukz_player, 1, WeakenedPlayerFrame, "HIGH")
	else
		WeakenedPlayerFrame.Panel = BarPanel(8, 250, 0, 30, "TOPLEFT", "BOTTOMLEFT", oUF_Tukz_player, 1, WeakenedPlayerFrame, "HIGH")
	end
